...
tct_cm1 = [0] * ga_fsgsp.num_generaciones
tct_cm2 = [0] * ga_fsgsp.num_generaciones
tct_cm3 = [0] * ga_fsgsp.num_generaciones
...
while iteracion < n_iteraciones:
    ...
    while gen < ga_fsgsp.num_generaciones:
        ...
        print("Group Scheduling - CM1 - TCT:\n Gen N°: {}, Iter: {}".format(gen, iteracion))

        # Guardar mejores y el promedio de la generación
        if tct_cm1[gen] == 0 or best_cm1 < tct_cm1[gen]:
            tct_cm1[gen] = best_cm1
    ...
    while gen < ga_fsgsp.num_generaciones:
        ...
        print("Group Scheduling - CM2 - TCT:\n Gen N°: {}, Iter: {}".format(gen, iteracion))

        # Guardar mejores y el promedio de la generación
        if tct_cm2[gen] == 0 or best_cm2 < tct_cm2[gen]:
            tct_cm2[gen] = best_cm2
    ...
    while gen < ga_fsgsp.num_generaciones:
        ...
        print("Group Scheduling - CM3 - TCT:\n Gen N°: {}, Iter: {}".format(gen, iteracion))

        # Guardar mejores y el promedio de la generación
        if tct_cm3[gen] == 0 or best_cm3 < tct_cm3[gen]:
            tct_cm3[gen] = best_cm3
...
df = pd.DataFrame([tct_cm1, tct_cm2, tct_cm3])

df.to_excel("results_conf_tct.xlsx")

df2 = pd.DataFrame([cm1_sched_sol, cm2_sched_sol, cm3_sched_sol])

df2.to_excel("results_conf_sols_tct.xlsx")
