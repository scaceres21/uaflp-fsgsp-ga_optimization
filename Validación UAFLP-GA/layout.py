...
class Layout:
    ...
    def __init__(self, num_depts, areas_depts, lados_instal,
                 ...
                 param_sever_k=3, euclidean=False):
    ...
    def obtener_atributos(self):
        print("\nATRIBUTOS DE LA CLASE:\n"
              ...
              "Parámetro de severidad de la penalización (k): {}".format(self.num_depts,
                                                                         self.areas_depts,
                                                                         self.lados_instal,
    ...
    def mostrar_layout(self, cromo_depts, cromo_bahias):
        ...
        names = ["Confección", "Estampado", "Terminación", "Oficinas", "Almacén MP",
                 "Almacén PT", "Recepción-Despacho"]
